...
namespace Assist.July._2022.BE2.Infrastructure.Interfaces
{
    public interface IListingRepository
    {
        ...
        Task<IEnumerable<Listing>> GetSortedAsync(string? sortOrder, string? locationFilter, string? priceRange, string? searchString, string? category, int pageNumber, int pageSize);
